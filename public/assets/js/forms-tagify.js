...
!(function () {
    ...
    l.on("dropdown:select", function (a) {
        a.detail.elm.classList.contains(
            `${l.settings.classNames.dropdownItem}__addAll`
        ) && l.dropdown.selectAll();
    ...
    const o = document.querySelector("#TagifyEmailList"),
        c = new Tagify(o, {
            pattern:
    ...
    o.nextElementSibling.addEventListener("click", function () {
        c.addEmptyTag();
    });
})();
