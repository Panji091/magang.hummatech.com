    ...
    ! function () {
        ...
        e && new PerfectScrollbar(e, {
            ...
            let t = e.currentTarget.value.toLowerCase(),
                ...
                r = [].slice.call(document.querySelectorAll("#chat-list li:not(.chat-contact-list-item-title)")),
                l = [].slice.call(document.querySelectorAll("#contact-list li:not(.chat-contact-list-item-title)"));
            m(r, 0, t, a), m(l, 0, t, c)
        })), o.addEventListener("submit", (e => {
            if (e.preventDefault(), n.value) {
                let e = document.createElement("div");
                e.className = "chat-message-text mt-2", e.innerHTML = '<p class="mb-0 text-break">' + n.value + "</p>", document.querySelector("li:last-child .chat-message-wrapper").appendChild(e), n.value = "", h()
            }
        }));
            ...
            if (null != v) {
                ...
                d.on("click", (function () {
                    ...
                    b.onspeechstart = function () {
                        y = !0
                    }, !1 === y && b.start(), b.onerror = function (e) {
                        y = !1
