...
!(function () {
    ...
    $(function () {
        ...
        var c = $("#bs-rangepicker-basic"),
            ...
            d = $("#bs-rangepicker-dropdown"),
            h = document.getElementsByClassName("cancelBtn");
        ...
        for (var k = 0; k < h.length; k++)
            h[k].classList.remove("btn-default"),
                h[k].classList.add("btn-label-primary");
        var u = $("#timepicker-basic"),
            b = $("#timepicker-min-max"),
            f = $("#timepicker-disabled-times"),
            y = $("#timepicker-format"),
            R = $("#timepicker-step"),
            w = $("#timepicker-24hours");
        u.length && u.timepicker({ orientation: isRtl ? "r" : "l" }),
            b.length &&
                b.timepicker({
                    minTime: "2:00pm",
                    maxTime: "7:00pm",
            ...
            R.length &&
                R.timepicker({ step: 15, orientation: isRtl ? "r" : "l" }),
            w.length &&
                w.timepicker({
                    show: "24:00",
                    timeFormat: "H:i:s",
