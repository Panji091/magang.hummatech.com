    ...
    <div class="row">
        @forelse ($divisions as $division)
            <div class="col-lg-3">
                ...
                <div class="modal fade" id="modal-edit-{{ $division->id }}" tabindex="-1" aria-labelledby="editDataDivisi"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="editDataDivisi">Edit Divisi</h5>
                            ...
                            <form method="POST" id="form-update">
                                ...
                                <div class="modal-body">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" value="{{ $division->name }}" class="form-control @error('name') is-invalid @enderror"
                                            id="name-edit" name="name" placeholder="Mis: Website, Mobile, dan lain-lain" />
                                        @error('name')
                                            <p class="text-danger">
                                                {{ $message }}
                                            </p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="gap-2">
                                ...
                                <button class="bg-transparent border-0 btn-edit" data-bs-toggle="modal"
                                    data-bs-target="#modal-edit-{{ $division->id }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-1">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                name="name" placeholder="Mis: Website, Mobile, dan lain-lain" />
                            @error('name')
                                <p class="text-danger">
                                    {{ $message }}
                                </p>
